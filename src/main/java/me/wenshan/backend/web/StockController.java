...
public class StockController {
    ...
    @Autowired
    private StockDayHisService stockDayHisService;
    ...
    @GetMapping (value = "/stockbasics/{curPage}") 
    public String stockbasics (@PathVariable Integer curPage, Model model)
        {
        if (curPage == null)
            curPage = 1;
        
        LBPage<StockBasics> page = new LBPage<StockBasics>();
        
        page.setTotalrecord(stockBasicsService.count());
        ...
        java.util.List<StockBasics> lst = stockBasicsService.getPageData(page.getFirstResult(),
                page.getMaxresult());
        ...
        return path + "/stockbasics";
        }

    @GetMapping (value = "/stockdayhist/{curPage}") 
    public String stockdayhist 
        (
        ...
        LBPage<StockDayHis> page = new LBPage<StockDayHis>();
        
        page.setTotalrecord(stockDayHisService.count());
        ...
        java.util.List<StockDayHis> lst = stockDayHisService.getPageData(page.getFirstResult(),
                page.getMaxresult());
