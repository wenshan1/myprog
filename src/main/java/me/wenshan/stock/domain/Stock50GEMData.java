...
@Entity
@Table(name = "stock50gemdata")
public class Stock50GEMData {
	@Id
	@Column(name="riqi")
    private Date riqi;
	...
	public Stock50GEMData (Date riqi, double close, String currStockName, String nStockname, String nnStockName)
	{
		this.riqi = riqi;
