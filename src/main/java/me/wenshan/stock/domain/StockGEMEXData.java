...
@Entity
@Table(name = "stockgemexdata")
public class StockGEMEXData {
	@Id
	@Column(name="riqi")
    private Date riqi;
	...
	public StockGEMEXData (Date riqi, double close, String currStockName, String nStockname, String nnStockName)
	{
		this.riqi = riqi;
