...
public class OptionManager {
	...
	public DataOption getDataOption () {
		...
		dataOption.setBeijingQuality(NumberUtils.toInteger(
				optionsService.getOptionValue(OptionConstants.BEIJING_QUALITY_MAX), 1000000)
				);
		dataOption.setNewsmthNum (NumberUtils.toInteger(
				optionsService.getOptionValue(OptionConstants.NEWSMTH_MAX), 1000)
				);
		dataOption.setStockDataNum (NumberUtils.toInteger(
				optionsService.getOptionValue(OptionConstants.STOCKDATA_YEAR_MAX), 10)
				);
		
		dataOption.setStockModelCycle(NumberUtils.toInteger(
                    optionsService.getOptionValue(OptionConstants.STOCK_MODEL_CYCLE), 20));
